...
import { buildCompanyPayload, normalizeCompanySymbol } from "./financial-normalizer.js";
...
export async function fetchCompanyPayload(rawSymbol) {
  const symbol = normalizeCompanySymbol(rawSymbol);
  if (!symbol) {
    throw new CompanyDataError(400, "INVALID_SYMBOL", "أدخل رمزًا صحيحًا مثل 2222 لشركة سعودية أو AAPL لشركة أمريكية.");
  }
